        ...
        {paginatedRequests.map((r) => {
          ...
          return (
            <button
              ...
              className={`group relative w-full overflow-hidden rounded-3xl border bg-card p-5 text-left shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg ${
                active ? "border-[color:var(--bamboo)] bg-[color:var(--bamboo)]/5 ring-4 ring-[color:var(--bamboo)]/10" : "border-border hover:border-border/80"
          ...
          <form onSubmit={submit} className="mt-8">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
              ...
              <Button type="submit" disabled={full} variant="primary" className="h-[48px] shrink-0 sm:mb-[2px]">
                {full ? t('detail.btn.full') : t('detail.btn.help')}
              </Button>
            </div>
          </form>
        </div>
